...
from goals.views import GoalCategoryCreateAPIView, GoalCategoryListAPIView, GoalCategoryDetailUpdateDeleteAPIView, \
    ...
    GoalCommentDetailUpdateDeleteAPIView
...
urlpatterns = [
    ...
    path('goal_category/<int:pk>', GoalCategoryDetailUpdateDeleteAPIView.as_view(), name='goal_category_detail_update_delete'),
    ...
    path('goal_comment/<int:pk>', GoalCommentDetailUpdateDeleteAPIView.as_view(), name='goal_comment_detail_update_delete'),
]
